<!-- CANONICAL SHARED BLOCK — single source of truth for the "Working Style & Discipline" section stamped into every repo's CLAUDE.md by the cuf skill. Edit shared process here, never in the individual CLAUDE.md files. No repo-specific content. -->
